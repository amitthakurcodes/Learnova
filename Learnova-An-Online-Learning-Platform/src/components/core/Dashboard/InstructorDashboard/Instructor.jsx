...
//         // CHANGE: null/undefined check add kiya
      ...
      {loading ? (
        ...
        <div>
          ...
          <div className="my-4 flex flex-col lg:flex-row gap-4">
            ...
            {/* Statistics */}
            <div className="flex flex-col rounded-md bg-richblack-800 p-4 sm:p-6 lg:min-w-[220px]">
              <p className="text-lg font-bold text-richblack-5 mb-4">Statistics</p>
              <div className="grid grid-cols-3 lg:grid-cols-1 gap-4">
                <div className="flex flex-col">
                  <p className="text-xs sm:text-sm text-richblack-200">Total Courses</p>
                  <p className="text-xl sm:text-2xl lg:text-3xl font-semibold text-richblack-50">
                    {courses.length}
                  </p>
                </div>
                <div className="flex flex-col">
                  <p className="text-xs sm:text-sm text-richblack-200">Total Students</p>
                  <p className="text-xl sm:text-2xl lg:text-3xl font-semibold text-richblack-50">
                    {totalStudents}
                  </p>
                </div>
                <div className="flex flex-col">
                  <p className="text-xs sm:text-sm text-richblack-200">Total Income</p>
                  <p className="text-xl sm:text-2xl lg:text-3xl font-semibold text-richblack-50">
                    Rs. {totalAmount}
                  </p>
                </div>
              ...
              {courses.slice(0, 3).map((course) => (
                <div key={course._id} className="w-full">
                  <img
                    src={course.thumbnail}
                    alt={course.courseName}
                    className="h-[160px] sm:h-[180px] w-full rounded-md object-cover"
                  />
                  <div className="mt-3">
