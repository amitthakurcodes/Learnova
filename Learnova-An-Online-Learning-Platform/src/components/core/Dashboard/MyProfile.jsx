...
export default function MyProfile() {
  ...
  return (
    <>
      ...
      {/* Profile Card */}
      <div className="flex flex-wrap items-center justify-between gap-4 rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-6">
        <div className="flex items-center gap-x-4">
          <img
            src={user?.image}
            alt={`profile-${user?.firstName}`}
      ...
      {/* About */}
      <div className="my-10 flex flex-col gap-y-6 rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-6">
        <div className="flex w-full items-center justify-between">
          <p className="text-lg font-semibold text-richblack-5">About</p>
          <IconBtn text="Edit" onclick={() => navigate("/dashboard/settings")}>
            <RiEditBoxLine />
