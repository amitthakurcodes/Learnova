      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="my-6 mb-8">
          <label htmlFor="public" className="inline-flex items-center text-base sm:text-lg">
            <input
              ...
              id="public"
              {...register("public")}
              className="h-4 w-4 rounded bg-richblack-500 text-richblack-400"
            />
            <span className="ml-2 text-richblack-400">
              Make this course as public
            </span>
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:justify-end w-full">
          ...
          <button
            ...
            type="button"
            onClick={goBack}
            className="w-full sm:w-auto flex justify-center items-center gap-x-2 rounded-md bg-richblack-300 py-2 px-4 font-semibold text-richblack-900"
          >
            Back
          </button>
