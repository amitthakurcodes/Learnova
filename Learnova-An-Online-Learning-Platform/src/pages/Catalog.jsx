...
//   if (!loading && catalogPageData && !catalogPageData.success) {
//     return <Error />
//   }
...
//         <div className="section_heading sm:overflow-visible">Courses to get you started</div>
...
//                 : catalogPageData?.data?.selectedCategory?.courses?.filter(
//                   (course) => {
...
//               ?.slice(0, 4)
//               .map((course, i) => (
//                 <Course_Card course={course} key={i} spacing="px-2" />
//               ))}
//           </div>
//         </div>
//       </div>
